...
assert_eq "$(project_label "$normal/feature-x")" dots.feature-x 'normal sibling worktree uses dot branch suffix'
...
assert_eq "$(project_label "$legacy/feature-x")" dots.feature-x 'legacy sibling worktree keeps dot branch suffix'
