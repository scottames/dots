...
- I use Fedora Silverblue with distrobox. If you need host access, ask.
...
- If hardware (yubikey) blocks git/ssh, do not attempt to work around it, ask.
## Git / Worktrees
...
- Never add attribution to git commit messages, including Co-authored-by
  trailers, “generated by” notices, or agent/model/tool credits, unless I
