...
map("n", "<M-h>", "<C-w>h", { desc = "window-left", silent = true })
map("n", "<M-Left>", "<C-w>h", { desc = "window-left", silent = true })
map("n", "<M-j>", "<C-w>j", { desc = "window-down", silent = true })
map("n", "<M-Down>", "<C-w>j", { desc = "window-down", silent = true })
map("n", "<M-k>", "<C-w>k", { desc = "window-up", silent = true })
map("n", "<M-Up>", "<C-w>k", { desc = "window-up", silent = true })
map("n", "<M-l>", "<C-w>l", { desc = "window-right", silent = true })
map("n", "<M-Right>", "<C-w>l", { desc = "window-right", silent = true })
-- -- resize
map("n", "<M-H>", "<cmd>vertical resize -2<CR>", { desc = "resize-left", silent = true })
map("n", "<M-S-Left>", "<cmd>vertical resize -2<CR>", { desc = "resize-left", silent = true })
map("n", "<M-J>", "<cmd>resize +2<CR>", { desc = "resize-down", silent = true })
map("n", "<M-S-Down>", "<cmd>resize +2<CR>", { desc = "resize-down", silent = true })
map("n", "<M-K>", "<cmd>resize -2<CR>", { desc = "resize-up", silent = true })
map("n", "<M-S-Up>", "<cmd>resize -2<CR>", { desc = "resize-up", silent = true })
map("n", "<M-L>", "<cmd>vertical resize +2<CR>", { desc = "resize-right", silent = true })
map("n", "<M-S-Right>", "<cmd>vertical resize +2<CR>", { desc = "resize-right", silent = true })
