...
function printf_info;      printf_white_bold  "$INFO $argv"   ; end
function printf_warn;      printf_yellow_bold "$WARNING $argv"; end
function printf_err;       printf_red_bold    "$CROSS $argv"  ; end
