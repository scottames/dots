...
abbr -a nonocl "nono wrap --profile claude-code --allow-cwd -- claude"
abbr -a nonoc "nono wrap --profile opencode-local --allow-cwd -- opencode"
abbr -a nonocc "nono wrap --profile opencode-local --allow-cwd -- opencode --continue"
abbr -a o open
abbr -a oc opencode
